...
Options:
  ...
  -u, --unload   Unload all v4l2loopback devices with 'axis-ip-camera-*' labels
  -c, --check    Check and list all loaded axis-ip-camera v4l2loopback devices
  -h, --help     Show this help message
  -v, --version  Show script version

Examples:
  ./vidip.sh -l           # Adds a new /dev/videoX labeled axis-ip-camera-X
  ./vidip.sh 192.168.0.90 # Streams from that IP into the first free axis-ip-camera device
